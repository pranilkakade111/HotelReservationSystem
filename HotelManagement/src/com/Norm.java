...
public class Norm 
{
    ...
    private String minCost(int lakeWoodCost, int bridgeWoodCost, int ridgeWoodCost) 
    {
        ...
        {
            return bridgeWoodRating > lakeWoodRating ? "BridgeWood" : "LakeWood";// Conditional operator or ternary operator
        } 
    ...
    {
        String input1 = "Regular: 16Mar2009(mon), 17Mar2009(tue), 18Mar2009(wed)"; 
        String input = "Rewards: 26Mar2009(thu), 27Mar2009(fri), 28Mar2009(sat)";
        Norm hotelRoom = new Norm();
